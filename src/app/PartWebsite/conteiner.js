        ...
        <section className="container">
            <div className="container-item-1">
                ...
                <p className="mt-1 flex item-3 btns"  style={{marginTop: '18px'}} >
                    <span><a href="https://www.playstation.com/pt-br/games/marvels-spider-man-miles-morales/" className="btn" target="_blank">Comprar Agora</a></span>
                    <span><a href="https://www.youtube.com/watch?v=NTunTURbyUU" className="btn-secondary " target="_blank">Ver o TREILER</a></span>
                </p>
                <p className="mt-2 flex align-items-center item-4" style={{marginTop: '18px', cursor: 'default'}}>

                    <svg  className="w-auto" style={{cursor: 'default'}} width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <svg  className="ml-2 w-auto " style={{cursor: 'default', marginLeft: '20px', }} width="62" height="28" viewBox="0 0 62 28" fill="none" xmlns="http://www.w3.org/2000/svg">
